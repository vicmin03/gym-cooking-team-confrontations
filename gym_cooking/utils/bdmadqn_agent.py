...
class RealAgent:
    ...
    def get_reward(self, old_obs, new_obs):
        ...
        rewards_dict = {recipe_utils.Chop: 10, recipe_utils.Merge: 50, recipe_utils.Deliver: 100, recipe_utils.Hoard: 1, recipe_utils.Steal: 40, recipe_utils.Trash: 3}
